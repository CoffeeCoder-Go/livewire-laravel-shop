...
<div class="m-3">
    ...
    @else
        <div class="container m-3 p-2 border border-primary">
            <h3><span class="text-danger">Erro!</span> Você tem perfil de comprador ou está usando outro perfil!</h3>
        </div>
    @endcan
